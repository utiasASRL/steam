//////////////////////////////////////////////////////////////////////////////////////////////
/// \file SimpleBAandSingerTrajPrior.cpp
...
int main(int argc, char** argv) {
  ...
  // Make Qc_inv
  Eigen::Matrix<double,6,6> Qc; Qc.setZero();
    Qc.diagonal() = Qc_diag;
  ...
  std::cout<<"added states"<<std::endl;
  ...
  std::cout<<"added landmarks"<<std::endl;
  ///
  /// Setup Cost Terms
  ///
  ...
  std::cout<<"appending prior cost terms..."<<std::endl;
