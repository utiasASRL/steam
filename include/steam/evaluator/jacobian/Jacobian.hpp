...
//////////////////////////////////////////////////////////////////////////////////////////////
template <int LHS_DIM = Eigen::Dynamic, int MAX_STATE_DIM = Eigen::Dynamic>
struct Jacobian
{

  typedef Eigen::Matrix<double, LHS_DIM, MAX_STATE_DIM> MATRIX_TYPE;
  ...
  /// \brief Constructor
  //////////////////////////////////////////////////////////////////////////////////////////////
  Jacobian(const StateKey& key, const MATRIX_TYPE& jac) : key(key), jac(jac) {
  }
