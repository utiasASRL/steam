...
class P2PDopplerCVSuperCostTerm : public BaseCostTerm {
 public:
  ...
  using Ptr = std::shared_ptr<P2PDopplerCVSuperCostTerm>;
  using ConstPtr = std::shared_ptr<const P2PDopplerCVSuperCostTerm>;
