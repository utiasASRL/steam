...
BiasInterpolator::Ptr BiasInterpolator::MakeShared(
    const Time& time, const Evaluable<InType>::ConstPtr& bias1,
...
BiasInterpolator::BiasInterpolator(const Time& time,
                                   const Evaluable<InType>::ConstPtr& bias1,
                                   const Time& time1,
                                   const Evaluable<InType>::ConstPtr& bias2,
                                   const Time& time2)
...
bool BiasInterpolator::active() const {
...
void BiasInterpolator::backward(const Eigen::MatrixXd& lhs,
