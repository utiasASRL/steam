//////////////////////////////////////////////////////////////////////////////////////////////
/// \file SteamSingerTrajPriorFactor.cpp
///
...
//////////////////////////////////////////////////////////////////////////////////////////////
bool SteamSingerTrajPriorFactor::isActive() const {
...
//////////////////////////////////////////////////////////////////////////////////////////////
Eigen::VectorXd SteamSingerTrajPriorFactor::evaluate() const {
  ...
  error.head<6>() = xi_21 - dt*knot1_->getVelocity()->getValue() - C1*knot1_->getAcceleration()->getValue();
  error.segment<6>(6) = J_21_inv*knot2_->getVelocity()->getValue() - knot1_->getVelocity()->getValue() - C2*knot1_->getAcceleration()->getValue();
  error.tail<6>() = -0.5*w*knot2_->getVelocity()->getValue() + J_21_inv*knot2_->getAcceleration()->getValue() - C3*knot1_->getAcceleration()->getValue();
...
//////////////////////////////////////////////////////////////////////////////////////////////
Eigen::VectorXd SteamSingerTrajPriorFactor::evaluate(const Eigen::MatrixXd& lhs,
  ...
  if(!knot1_->getAcceleration()->isLocked()) {
    ...
    // Fill in matrix
    Eigen::Matrix<double,18,6> jacobian;
    jacobian.topRows<6>() = -C1;
    jacobian.block<6,6>(6,0) = -C2;
    jacobian.bottomRows<6>() = -C3;
    jacref.jac = lhs * jacobian;
  ...
  // Return error
  Eigen::Matrix<double,18,1> error;
  error.head<6>() = xi_21 - deltaTime*knot1_->getVelocity()->getValue() - C1*knot1_->getAcceleration()->getValue();
  error.segment<6>(6) = J_21_inv*knot2_->getVelocity()->getValue() - knot1_->getVelocity()->getValue() - C2*knot1_->getAcceleration()->getValue();
  error.tail<6>() = -0.5*w*knot2_->getVelocity()->getValue() + J_21_inv*knot2_->getAcceleration()->getValue() - C3*knot1_->getAcceleration()->getValue();
